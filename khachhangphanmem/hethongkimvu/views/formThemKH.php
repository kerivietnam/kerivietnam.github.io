                                ...
                                <table id="datatable" class="table table-striped table-bordered" cellspacing="0"
                                    ...
                                    <tbody id="bodyEmployer">
                                        ...
                                        <tr class="load_data_employer_io">
                                            ...
                                            <td><a  href="formMainternanceAll.php"  target=blank>TT Bảo Trì</td>
                                            <td style="text-align:right;">
                                                <button class="btn btn-primary update_employer" id="btnUpdate" data-toggle="modal" data-target="#modalAddEmployer"
                                                    data-id_update_employer="<?php echo $value["idEmployer"] ?>">Sửa</button>
                                             <button class="btn btn-warning delete_employer " id="btnDeleteEmployer"
