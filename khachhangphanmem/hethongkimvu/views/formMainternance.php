                    ...
                    <div class="col-md-12">
                        <div class="card ">
                            <div class="card-header ">
								...
								&nbsp;	<button style="margin-right:0px;" name="downloadSheet" id = "downloadSheet" onclick="doDownload('mainterancedata', '<?=$_GET["customername"].$currentStatusName?>');">Download</button>
								</h4>
                            </div>
