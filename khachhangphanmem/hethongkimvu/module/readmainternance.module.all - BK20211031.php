...
$workstatusWhereCondition =  " p.workStatus IN (SELECT id from tbl_keri_workstatus where workStatus = '$workStatus') ";
if ($workStatus == "") {
...
LEFT JOIN tbl_keri_picture_free pf ON p.idPictureFree = pf.idPictureFree
INNER JOIN tbl_keri_product prd ON prd.idProduct = p.idProject ".$allWhereCondition.
"ORDER BY 
e.idEmployer,
s.seri_id,  
p.idProject, 
...
<thead>
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" class="bg-table" colspan="2" rowspan="2">TÌNH TRẠNG</th>
                                        </tr>
                                    </thead>
';
